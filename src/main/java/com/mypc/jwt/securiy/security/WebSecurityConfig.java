package com.mypc.jwt.securiy.security;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                .antMatchers(HttpMethod.PATCH, "/products/increment").hasAnyRole("MANAGERS")
                .antMatchers(HttpMethod.PATCH, "/products/decrement").hasAnyRole("MANAGERS")
